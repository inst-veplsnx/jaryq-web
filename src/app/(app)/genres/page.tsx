                  ...
                  <li key={genre.id}>
                    ...
                    >
                      ...
                      >
                        <BookOpen
                          className={cn(
                            "w-7 h-7 lg:w-8 lg:h-8 transition-transform duration-(--duration-jaryq-base) group-hover:scale-110 group-hover:-rotate-4 motion-reduce:transition-none motion-reduce:group-hover:scale-100 motion-reduce:group-hover:rotate-0",
                            accent.text
                          )}
                        />
                      </span>
