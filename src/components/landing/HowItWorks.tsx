...
const steps = [
  ...
  },
  {
    ...
    title: "Кітап таңдау",
    description:
      "Аудиокітаптар арасынан жанр бойынша іздеңіз немесе барлығын шолыңыз.",
    bg: "var(--color-jaryq-primary-light)",
    dark: false,
  },
  {
    number: "03",
    ...
    <section className="py-24 px-4 bg-white" id="how-it-works">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          {steps.map(({ number, icon: Icon, title, description, bg, dark }) => (
            <li
              key={number}
              data-scroll-reveal="true"
